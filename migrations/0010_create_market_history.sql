-- Migration: Market History Table for Aggregated Historical Data
-- Created: 2024-12-24
-- Purpose: Store hourly aggregated market data for long-term analysis
...
CREATE INDEX idx_market_history_exchange ON market_history(exchange);
CREATE INDEX idx_market_history_symbol ON market_history(normalized_symbol);
CREATE INDEX idx_market_history_hour ON market_history(hour_timestamp);
CREATE INDEX idx_market_history_exchange_symbol ON market_history(exchange, normalized_symbol);
CREATE INDEX idx_market_history_exchange_hour ON market_history(exchange, hour_timestamp);
