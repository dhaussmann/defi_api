#!/bin/bash
# Import Extended V3 Historical Funding Rates
# Imports last 30 days of funding rate data into extended_funding_v3 table
...
echo "=========================================="
echo "Extended V3 Historical Data Import"
echo "=========================================="
echo "Days back: $DAYS_BACK"
echo "Target table: extended_funding_v3"
echo ""

# Trigger import via API endpoint
echo "[1/2] Triggering Extended V3 import..."
RESPONSE=$(curl -s -X POST "$API_URL/debug/v3-extended-import?days=$DAYS_BACK")
...
echo ""
echo "=========================================="
echo "Extended V3 Import Complete"
echo "=========================================="
