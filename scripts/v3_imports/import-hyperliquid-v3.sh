#!/bin/bash
# Import Hyperliquid V3 Historical Funding Rates
# Imports last 30 days of funding rate data into hyperliquid_funding_v3 table
...
echo "=========================================="
echo "Hyperliquid V3 Historical Data Import"
echo "=========================================="
echo "Days back: $DAYS_BACK"
echo "Target table: hyperliquid_funding_v3"
echo ""

# Trigger import via API endpoint
echo "[1/2] Triggering Hyperliquid V3 import..."
RESPONSE=$(curl -s -X POST "$API_URL/debug/v3-hyperliquid-import?days=$DAYS_BACK")
...
npx wrangler d1 execute defiapi-db-write --remote --command="
  ...
  FROM hyperliquid_funding_v3
"

echo ""
echo "=========================================="
echo "Hyperliquid V3 Import Complete"
echo "=========================================="
