...
# V2: Import Extended Raw Data (Working Version)
...
echo "=================================================="
echo "V2 Extended Raw Data Import (Working)"
echo "=================================================="
...
# Extended supported tokens (from testing the API)
TOKENS="BTC
ETH
SOL
STRK"
...
echo "Extended supports ${TOKEN_COUNT} tokens: $(echo $TOKENS | tr '\n' ' ')"
echo ""
...
while read -r TOKEN; do
  CURRENT=$((CURRENT + 1))
  SYMBOL="${TOKEN}-USD"
  echo "[${CURRENT}/${TOKEN_COUNT}] ${SYMBOL}..."
