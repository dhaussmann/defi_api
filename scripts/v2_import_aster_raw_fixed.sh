...
# V2: Import Aster Raw Data (Fixed Version)
# Uses temporary SQL file and proper interval detection
...
echo "=================================================="
echo "V2 Aster Raw Data Import (Fixed)"
echo "=================================================="
...
while IFS=: read -r SYMBOL BASE_ASSET QUOTE_ASSET; do
  ...
  # Calculate interval and generate SQL
  echo "BEGIN TRANSACTION;" > "$TEMP_SQL"
